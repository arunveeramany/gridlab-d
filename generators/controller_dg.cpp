...
int controller_dg::init(OBJECT* parent)
{
    ...
    else
    {
        ...
        {
            gl_error(
                "Although controller given group id, no dgs with given group id "
                "found.");
            /*  TROUBLESHOOT
    ...
    if (deltamode_inclusive)
    {
        ...
        else
        {
            ...
            {
                GL_THROW(
                    "controller_dg:%s - Failed to map frequency checking variable "
            ...
            {
                GL_THROW(
                    "controller_dg:%s - failed to add object to generator "
    ...
    else  // Not enabled for this model
    {
        ...
        {
            gl_warning(
                "diesel_dg:%d %s - Deltamode is enabled for the module, but "
                "not this generator!",
                                 ...
                                 unsigned int iteration_count_val)
{
    ...
    for (int index = 0; index < dgswitchFound; index++)
    {
        ...
        {
            gl_warning(
                "Reverse real power flow detected at generator switch %s, "
