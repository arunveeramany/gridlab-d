...
export CXXFLAGS="-Werror=return-type -Werror=write-strings -fPIC -fPIC -no-pie -fPIC -fno-PIE $<$<CONFIG:Debug>:-g -O0> -Wno-format-overflow -Wno-format-truncation -Wno-stringop-overflow"
