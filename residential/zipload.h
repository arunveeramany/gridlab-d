...
public:
	// Tri-state: default UNSPECIFIED lets us preserve is_240 unless user sets configuration
	enum zip_configuration_t
	{
		ZIPCONF_IS110 = 0,
		ZIPCONF_IS220 = 1,
		ZIPCONF_UNSPECIFIED = 2
	};
	zip_configuration_t configuration; // published as 'configuration'
};
