...
void house_e::push_complex_powerflow_values()
{
	...
	if (commercial_load_parent == true)
	{
		...
		*/
		...
		complex balShunt = (value_Shunt[0] + value_Shunt[1] + value_Shunt[2] * 4.0) / (internalTurnsRatio * internalTurnsRatio) / denom;
		int insertS = 0;
		if (balShunt.Mag() > 0.0)
		{
			insertS = 1;
		...
		complex balCurrent = (value_Line_I[0] + value_Line_I[1] + value_Line_I[2] * 2.0) / internalTurnsRatio / denom;
		int insertI = 0;
