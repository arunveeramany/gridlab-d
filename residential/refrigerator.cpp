...
refrigerator::refrigerator(MODULE *module) : residential_enduse(module)
{
	...
	if (oclass == nullptr)
	{
		...
		oclass = gld_class::create(module, "refrigerator", sizeof(refrigerator), PC_PRETOPDOWN | PC_BOTTOMUP | PC_AUTOLOCK);
		if (oclass == nullptr)
...
static TIMESTAMP sync_refrigerator_impl(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass, TIMESTAMP t1)
{
	refrigerator *my = object_data<refrigerator>(obj);
...
#ifndef __APPLE__
extern "C" MODULE_API TIMESTAMP sync_refrigerator(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass, TIMESTAMP t1)
{
	return sync_refrigerator_impl(obj, t0, pass, t1);
}
#else
extern "C" MODULE_API TIMESTAMP sync_refrigerator(void *object, ...)
{
	va_list args;
